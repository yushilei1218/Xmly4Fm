...
/**
 * Created by yushilei on 2016/2/19.
 */
public class PushReceiver extends PushMessageReceiver {
    ...
    public void onNotificationClicked(Context context, String title,
        ...
        if (!TextUtils.isEmpty(customContentString)) {
            ...
            try {
                ...
                if (!customJson.isNull("from")) {
                    String from = customJson.getString("from");
                    if (from.equals("notifications")) {
                        long trackId = customJson.getLong("trackId");
                        startTrackPlayingActivity(context, trackId);
                    }
                }
    ...
    private void startTrackPlayingActivity(Context context, long trackId) {

        Intent intent = new Intent();
        intent.putExtra("trackId", trackId);
        intent.setClass(context.getApplicationContext(), TrackPlayingActivity.class);
